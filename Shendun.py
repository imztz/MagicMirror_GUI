...
class Shendun(QtWidgets.QMainWindow):
    def __init__(self):
        super(Shendun, self).__init__()
        self.setupUi(self)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "深蹲"))
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; color:#ffffff;\">现在是‘深蹲’模式！</span></p></body></html>"))

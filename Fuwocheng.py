...
class Fuwocheng(QtWidgets.QMainWindow):

    def __init__(self):
        super(Fuwocheng, self).__init__()
        self.setupUi(self)
...
"background-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "俯卧撑"))
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; color:#ffffff;\">现在是‘俯卧撑’模式！</span></p></body></html>"))

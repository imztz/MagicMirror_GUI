...
class Jingzi(QtWidgets.QMainWindow):
    def __init__(self):
        super(Jingzi, self).__init__()
        self.setupUi(self)
...
"background-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "镜子"))
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; color:#ffffff;\">现在是‘镜子’模式！</span></p></body></html>"))
